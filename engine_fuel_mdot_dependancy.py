...
mdot_start = ox_mdot / OF_end
mdot_end = ox_mdot / OF_start

fuel_mdot_arr = np.linspace(mdot_start, mdot_end, 500)
...
dF_dmdotfuel = np.gradient(thrust, fuel_mdot_arr)
